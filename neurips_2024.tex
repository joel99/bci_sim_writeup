...
Native policies reliably converge to completely solving the 2D reach whether the endpoint is velocity or acceleration controlled (despite sensorimotor delay).
...
\subsection{Dual-plant RL adapts to visuomotor rotations but not arbitrary BCIs.}

- Native MLP rotations
- Random BCIs are not learnable
...
- Musculoskeletal proof of concept - show eval
